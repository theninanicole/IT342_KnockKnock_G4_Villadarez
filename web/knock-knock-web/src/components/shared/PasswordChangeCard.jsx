    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-[0_18px_35px_rgba(15,23,42,0.12)] overflow-hidden">
      <div className="px-6 py-6 sm:px-8">
        ...
        <div className="mt-5 flex justify-end">
          <button
            type="button"
            className="inline-flex items-center rounded-full bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed"
